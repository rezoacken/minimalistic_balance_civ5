...
public:
	...
	BeliefTypes GetSecondaryReligionFollowerBelief(bool bSecondBelief); //modAcken returns one of the two follower belief
#endif
...
private:
	...
	bool BuyAnyAvailableFaithBuilding(bool bSecondary=false);
#else
