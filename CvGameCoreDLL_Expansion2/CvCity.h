...
public:
	...
	BuildingTypes ChooseFreeDefenseBuilding() const;
#endif
...
#ifdef AMB_POLICY_FREEDEFENSE
	bool IsOwedDefenseBuilding() const;
	void SetOwedDefenseBuilding(bool bNewValue);
#endif
	...
	int GetWLTKDNoResource() const;
	void SetWLTKDNoResource(int iValue);
	void ChangeWLTKDNoResource(int iChange);
#endif
...
#ifdef AMB_WLTKD_RESET
	FAutoVariable<int, CvCity> m_iWLTKDNoResource;
#endif
