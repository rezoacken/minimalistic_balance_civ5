...
#ifdef AMB_MOD_H
#ifdef AMB_AI_DEAL_LOGICAL_VALUES
	GD_INT_DEF(AMB_AI_DEAL_AI_INTEREST)
	GD_INT_DEF(AMB_AI_DEAL_HUMAN_INTEREST)
#endif
#ifdef MOD_GLOBAL_BREAK_CIVILIAN_1UPT
	GD_INT_DEF(MOD_STACKCIVILIAN)
#endif
#ifdef AMB_DIPLOAI_RECKLESS_EXPANDER_OVERHAUL
	GD_INT_DEF(AMB_AI_RECKLESS_EXPANDER_APPROACH_FRIENDLY_MOD)
	GD_INT_DEF(AMB_AI_RECKLESS_EXPANDER_APPROACH_NEUTRAL_MOD)
	GD_INT_DEF(AMB_AI_RECKLESS_EXPANDER_APPROACH_GUARDED_MOD)
	GD_INT_DEF(AMB_AI_RECKLESS_EXPANDER_APPROACH_HOSTILE_MOD)
	GD_INT_DEF(AMB_AI_RECKLESS_EXPANDER_APPROACH_DECEPTIVE_MOD)
	GD_INT_DEF(AMB_AI_RECKLESS_EXPANDER_APPROACH_WAR_MOD)
	GD_INT_DEF(AMB_AI_RECKLESS_EXPANDER_APPROACH_AFRAID_MOD)
	GD_INT_DEF(AMB_AI_RECKLESS_EXPANDER_STRENGTH_MOD)
	GD_INT_DEF(AMB_AI_RECKLESS_EXPANDER_PERSONALITY_MOD)
	GD_INT_DEF(AMB_AI_RECKLESS_EXPANDER_DOF_MOD)
	GD_INT_DEF(AMB_AI_RECKLESS_EXPANDER_DENOUNCE_MOD)
	GD_INT_DEF(AMB_AI_RECKLESS_EXPANDER_NEIGHBOURS_MOD)
	GD_INT_DEF(AMB_AI_RECKLESS_EXPANDER_CLOSE_MOD)
	GD_INT_DEF(AMB_AI_RECKLESS_EXPANDER_FAR_MOD)
	GD_INT_DEF(AMB_AI_RECKLESS_EXPANDER_DISTANT_MOD)
	GD_INT_DEF(AMB_AI_RECKLESS_EXPANDER_MOD_APPROACH_MINOR)
	GD_INT_DEF(AMB_AI_RECKLESS_EXPANDER_MOD_APPROACH_MAJOR)
	GD_INT_DEF(AMB_AI_RECKLESS_EXPANDER_MOD_APPROACH_SEVERE)
	GD_INT_DEF(AMB_AI_RECKLESS_EXPANDER_MOD_APPROACH_CRITICAL)
#endif
#ifdef AMB_AI_WARMONGER
	GD_INT_DEF(AMB_AI_WARMONGER_CB_APPROACH_WAR_MOD)
	GD_INT_DEF(AMB_AI_WARMONGER_CB_APPROACH_DECEPTIVE_MOD)
#endif
#ifdef AMB_APPROACH_WAR_CURRENTLY_HOSTILE
	GD_INT_DEF(APPROACH_WAR_CURRENTLY_HOSTILE)
#endif
#ifdef AMB_GS_CONQUEST_ARMY_SIZE_BOOST
	GD_INT_DEF(GS_CONQUEST_ARMY_SIZE_BOOST)
#endif
#ifdef AMB_APPROACH_DISTANCE_ADDITIONAL_MODIFIERS
	GD_INT_DEF(APPROACH_HOSTILE_PROXIMITY_DISTANT)
	GD_INT_DEF(APPROACH_HOSTILE_PROXIMITY_FAR)
#endif
#if defined(AMB_AI_GS_CULTURE_POPULAR_CIV_MOD)
	inline int getAI_GS_CULTURE_POPULAR_CIV_MOD()//modAcken
	{
		return m_iAI_GS_CULTURE_POPULAR_CIV_MOD;
	}
#endif
#if defined(AMB_AI_GS_CULTURE_FAMILIAR_CIV_MOD)
	inline int getAI_GS_CULTURE_FAMILIAR_CIV_MOD()//modAcken
	{
		return m_iAI_GS_CULTURE_FAMILIAR_CIV_MOD;
	}
#endif
#endif
...
#ifdef AMB_MOD_H
#ifdef MOD_GLOBAL_BREAK_CIVILIAN_1UPT
	GD_INT_DECL(MOD_STACKCIVILIAN);
#endif
#ifdef AMB_AI_DEAL_LOGICAL_VALUES
	GD_INT_DECL(AMB_AI_DEAL_AI_INTEREST);
	GD_INT_DECL(AMB_AI_DEAL_HUMAN_INTEREST);
#endif
#ifdef AMB_DIPLOAI_RECKLESS_EXPANDER_OVERHAUL
	GD_INT_DECL(AMB_AI_RECKLESS_EXPANDER_APPROACH_FRIENDLY_MOD);
	GD_INT_DECL(AMB_AI_RECKLESS_EXPANDER_APPROACH_NEUTRAL_MOD);
	GD_INT_DECL(AMB_AI_RECKLESS_EXPANDER_APPROACH_GUARDED_MOD);
	GD_INT_DECL(AMB_AI_RECKLESS_EXPANDER_APPROACH_HOSTILE_MOD);
	GD_INT_DECL(AMB_AI_RECKLESS_EXPANDER_APPROACH_DECEPTIVE_MOD);
	GD_INT_DECL(AMB_AI_RECKLESS_EXPANDER_APPROACH_WAR_MOD);
	GD_INT_DECL(AMB_AI_RECKLESS_EXPANDER_APPROACH_AFRAID_MOD);
	GD_INT_DECL(AMB_AI_RECKLESS_EXPANDER_STRENGTH_MOD);
	GD_INT_DECL(AMB_AI_RECKLESS_EXPANDER_PERSONALITY_MOD);
	GD_INT_DECL(AMB_AI_RECKLESS_EXPANDER_DOF_MOD);
	GD_INT_DECL(AMB_AI_RECKLESS_EXPANDER_DENOUNCE_MOD);
	GD_INT_DECL(AMB_AI_RECKLESS_EXPANDER_NEIGHBOURS_MOD);
	GD_INT_DECL(AMB_AI_RECKLESS_EXPANDER_CLOSE_MOD);
	GD_INT_DECL(AMB_AI_RECKLESS_EXPANDER_FAR_MOD);
	GD_INT_DECL(AMB_AI_RECKLESS_EXPANDER_DISTANT_MOD);
	GD_INT_DECL(AMB_AI_RECKLESS_EXPANDER_MOD_APPROACH_MINOR);
	GD_INT_DECL(AMB_AI_RECKLESS_EXPANDER_MOD_APPROACH_MAJOR);
	GD_INT_DECL(AMB_AI_RECKLESS_EXPANDER_MOD_APPROACH_SEVERE);
	GD_INT_DECL(AMB_AI_RECKLESS_EXPANDER_MOD_APPROACH_CRITICAL);
#endif
#ifdef AMB_AI_WARMONGER
	GD_INT_DECL(AMB_AI_WARMONGER_CB_APPROACH_WAR_MOD);
	GD_INT_DECL(AMB_AI_WARMONGER_CB_APPROACH_DECEPTIVE_MOD);
#endif
#ifdef AMB_APPROACH_WAR_CURRENTLY_HOSTILE
	GD_INT_DECL(APPROACH_WAR_CURRENTLY_HOSTILE);
#endif
#ifdef AMB_GS_CONQUEST_ARMY_SIZE_BOOST
	GD_INT_DECL(GS_CONQUEST_ARMY_SIZE_BOOST);
#endif
#ifdef AMB_APPROACH_DISTANCE_ADDITIONAL_MODIFIERS
	GD_INT_DECL(APPROACH_HOSTILE_PROXIMITY_DISTANT);
	GD_INT_DECL(APPROACH_HOSTILE_PROXIMITY_FAR);
#endif
#if defined(AMB_AI_GS_CULTURE_POPULAR_CIV_MOD)
	int m_iAI_GS_CULTURE_POPULAR_CIV_MOD;//modAcken
#endif
#if defined(AMB_AI_GS_CULTURE_FAMILIAR_CIV_MOD)
	int m_iAI_GS_CULTURE_FAMILIAR_CIV_MOD;//modAcken
#endif
#endif
