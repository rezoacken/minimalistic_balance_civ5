...
CvUnitEntry::CvUnitEntry(void) :
	...
	m_bUniqueBuyableWithFaith(false),
#endif
...
#ifdef AMB_CIV_UNITFAITH
	m_bUniqueBuyableWithFaith = kResults.GetBool("UniqueBuyableWithFaith");
#endif
...
#ifdef AMB_CIV_UNITFAITH
/// Do we need a belief to unlock faith purchasing of this unit?
bool CvUnitEntry::IsUniqueBuyableWithFaith() const
{
	return m_bUniqueBuyableWithFaith;
}
#endif
