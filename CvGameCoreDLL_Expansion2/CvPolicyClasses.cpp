...
CvPolicyEntry::CvPolicyEntry(void):
	...
	m_iBuildingGoldToCulture(0),
#endif
#if defined(AMB_POLICY_EXTRATRADEROUTES)
	m_iExtraTradeRoutes(0), //modAcken default value for extra route
#endif
#if defined(AMB_POLICY_PROPHETSPAWNBONUSPERFOLLOWER)
	m_iProphetSpawnGoldenAgeBonusPerFollower(0), //modAcken default value
	m_iProphetSpawnGoldBonusPerFollower(0), //modAcken default value
	m_iProphetSpawnProductionBonusPerFollower(0), //modAcken default value
#endif
#if defined(AMB_POLICY_EXTRAHAPPINESSPERFOLLOWINGCITY)
	m_iExtraHappinessForFollowingCity(0), //modAcken default value
#endif
#if defined(AMB_POLICY_EXTRAHAPPINESSPERFOLLOWINGCITY)
	m_iAdditionalPersonalQuest(0),
#endif
#if defined(AMB_POLICY_FASTERPERSONALQUEST)
	m_iFasterPersonalQuest(0),
#endif
#if defined(AMB_POLICY_BONUSMINORYIELD)
	m_iBonusMinorYield(0),
#endif
#ifdef AMB_POLICY_IDEOLOGIES
	m_iExtraCoupChance(0),
	m_iRemoveCoupCapChance(0),
	m_iCityStrengthModifier(0),
	...
	m_iNumCitiesFreeDefenseBuilding(0),
#endif
...
#if defined(AMB_POLICY_YIELDCHANGEPERMINORTRADEROUTE)
	m_piYieldChangePerMinorTradeRoute(NULL),
#endif
#if defined(AMB_POLICY_YIELDCHANGEPERSEAINTERNATIONALTRADEROUTE)
	m_piYieldChangePerSeaInternationalTradeRoute(NULL),
#endif
	m_pabFreePromotion(NULL),
	m_paiUnitCombatProductionModifiers(NULL),
	m_paiUnitCombatFreeExperiences(NULL),
#if defined(AMB_POLICY_BUILDINGCHANGETOURISMCHANGES)
...
#if defined(AMB_POLICY_YIELDCHANGEPERMINORTRADEROUTE)
	SAFE_DELETE_ARRAY(m_piYieldChangePerMinorTradeRoute);
#endif
#if defined(AMB_POLICY_YIELDCHANGEPERSEAINTERNATIONALTRADEROUTE)
	SAFE_DELETE_ARRAY(m_piYieldChangePerSeaInternationalTradeRoute);
#endif
...
#if defined(AMB_POLICY_BUILDINGCHANGETOURISMCHANGES) //obsolete ?
...
bool CvPolicyEntry::CacheResults(Database::Results& kResults, CvDatabaseUtility& kUtility)
{
	...
	//Basic Properties
#ifdef AMB_POLICY_BUILDINGGOLDTOCULTURE
	m_iBuildingGoldToCulture = kResults.GetInt("BuildingGoldToCulture");
#endif
#if defined(AMB_POLICY_EXTRATRADEROUTES)
	m_iExtraTradeRoutes = kResults.GetInt("ExtraTradeRoutes");//modAcken To read in the XML the number of extra TR from policy
#endif
#if defined(AMB_POLICY_PROPHETSPAWNBONUSPERFOLLOWER)
	m_iProphetSpawnGoldenAgeBonusPerFollower = kResults.GetInt("ProphetSpawnGoldenAgeBonusPerFollower");//modAcken To read in the XML
	m_iProphetSpawnGoldBonusPerFollower = kResults.GetInt("ProphetSpawnGoldBonusPerFollower");//modAcken To read in the XML
	m_iProphetSpawnProductionBonusPerFollower = kResults.GetInt("ProphetSpawnProductionBonusPerFollower");//modAcken To read in the XML
#endif
#if defined(AMB_POLICY_EXTRAHAPPINESSPERFOLLOWINGCITY)
	m_iExtraHappinessForFollowingCity = kResults.GetInt("ExtraHappinessForFollowingCity");//modAcken 
#endif
#if defined(AMB_POLICY_ADDITIONALPERSONALQUEST)
	m_iAdditionalPersonalQuest = kResults.GetInt("AdditionalPersonalQuest");//modAcken 
#endif
#if defined(AMB_POLICY_FASTERPERSONALQUEST)
	m_iFasterPersonalQuest = kResults.GetInt("FasterPersonalQuest");//modAcken 
#endif
#if defined(AMB_POLICY_BONUSMINORYIELD)
	m_iBonusMinorYield = kResults.GetInt("BonusMinorYield");//modAcken 
#endif
#ifdef AMB_POLICY_IDEOLOGIES
	m_iExtraCoupChance = kResults.GetInt("ExtraCoupChance");
	m_iRemoveCoupCapChance = kResults.GetInt("RemoveCoupCapChance");
	m_iCityStrengthModifier = kResults.GetInt("CityStrengthModifier");
...
#ifdef AMB_POLICY_FREEDEFENSE
	m_iNumCitiesFreeDefenseBuilding = kResults.GetInt("NumCitiesFreeDefenseBuilding");
#endif
...
#if defined(AMB_POLICY_YIELDCHANGEPERMINORTRADEROUTE)
	kUtility.SetYields(m_piYieldChangePerMinorTradeRoute, "Policy_YieldChangePerMinorTradeRoute", "PolicyType", szPolicyType);
#endif
#if defined(AMB_POLICY_YIELDCHANGEPERSEAINTERNATIONALTRADEROUTE)
	kUtility.SetYields(m_piYieldChangePerSeaInternationalTradeRoute, "Policy_YieldChangePerSeaInternationalTradeRoute", "PolicyType", szPolicyType);
#endif
...
///modAcken Returns m_iExtraHappinessForFollowingCities
#if defined(AMB_POLICY_BUILDINGGOLDTOCULTURE)
	int CvPolicyEntry::GetBuildingGoldToCulture() const
	{
		return m_iBuildingGoldToCulture;
	}
#endif
#if defined(AMB_POLICY_ADDITIONALPERSONALQUEST)
	int CvPolicyEntry::GetAdditionalPersonalQuest() const
	{
		return m_iAdditionalPersonalQuest;
	}
#endif
#if defined(AMB_POLICY_FASTERPERSONALQUEST)
	int CvPolicyEntry::GetFasterPersonalQuest() const
	{
		return m_iFasterPersonalQuest;
	}
#endif
#if defined(AMB_POLICY_BONUSMINORYIELD)
	int CvPolicyEntry::GetBonusMinorYield() const
	{
		return m_iBonusMinorYield;
	}
#endif
#ifdef AMB_POLICY_IDEOLOGIES
	int CvPolicyEntry::GetExtraCoupChance() const
	{
		return m_iExtraCoupChance;
	}
	int CvPolicyEntry::GetRemoveCoupCapChance() const
	{
		return m_iRemoveCoupCapChance;
	}
	int CvPolicyEntry::GetCityStrengthModifier() const
	{
		return m_iCityStrengthModifier;
	}
	int CvPolicyEntry::GetExtraCityHitPoints() const
	{
		return m_iExtraCityHitPoints;
	}
	int CvPolicyEntry::GetSpyRankChange() const
	{
		return m_iSpyRankChange;
	}
	int CvPolicyEntry::GetInstantSpyRankChange() const
	{
		return m_iInstantSpyRankChange;
	}
#endif
#if defined(AMB_POLICY_EXTRAHAPPINESSPERFOLLOWINGCITY)
	int CvPolicyEntry::GetExtraHappinessForFollowingCity() const
	{
		return m_iExtraHappinessForFollowingCity;
	}
#endif
///modAcken Returns m_iProphetSpawnProductionBonusPerFollower
#if defined(AMB_POLICY_PROPHETSPAWNBONUSPERFOLLOWER)
		int CvPolicyEntry::GetProphetSpawnProductionBonusPerFollower() const
		{
			return m_iProphetSpawnProductionBonusPerFollower;
		}
	///modAcken Returns m_iProphetSpawnGoldBonusPerFollower
	int CvPolicyEntry::GetProphetSpawnGoldBonusPerFollower() const
		{
			return m_iProphetSpawnGoldBonusPerFollower;
		}
	///modAcken Returns m_iProphetSpawnGoldenAgeBonusPerFollower
	int CvPolicyEntry::GetProphetSpawnGoldenAgeBonusPerFollower() const
		{
			return m_iProphetSpawnGoldenAgeBonusPerFollower;
		}
#endif
#if defined(AMB_POLICY_EXTRATRADEROUTES)
	///modAcken Extra routes from policy
...
#ifdef AMB_POLICY_FREEDEFENSE
/// Cities that receive a free culture building
int CvPolicyEntry::GetNumCitiesFreeDefenseBuilding() const
{
	return m_iNumCitiesFreeDefenseBuilding;
}
#endif
...
#if defined(AMB_POLICY_YIELDCHANGEPERMINORTRADEROUTE)
int CvPolicyEntry::GetYieldChangePerMinorTradeRoute(int i) const
{
	CvAssertMsg(i < NUM_YIELD_TYPES, "Index out of bounds");
	CvAssertMsg(i > -1, "Index out of bounds");
	return m_piYieldChangePerMinorTradeRoute ? m_piYieldChangePerMinorTradeRoute[i] : -1;
}
int* CvPolicyEntry::GetYieldChangePerMinorTradeRouteArray() const
{
	return m_piYieldChangePerMinorTradeRoute;
}
#endif
#if defined(AMB_POLICY_YIELDCHANGEPERSEAINTERNATIONALTRADEROUTE)
int CvPolicyEntry::GetYieldChangePerSeaInternationalTradeRoute(int i) const
{
	CvAssertMsg(i < NUM_YIELD_TYPES, "Index out of bounds");
	CvAssertMsg(i > -1, "Index out of bounds");
	return m_piYieldChangePerSeaInternationalTradeRoute ? m_piYieldChangePerSeaInternationalTradeRoute[i] : -1;
}
int* CvPolicyEntry::GetYieldChangePerSeaInternationalTradeRouteArray() const
{
	return m_piYieldChangePerSeaInternationalTradeRoute;
}
#endif
...
int CvPolicyEntry::GetBuildingClassTourismChange(int i) const
{
	CvAssertMsg(i < GC.getNumBuildingClassInfos(), "Index out of bounds");
	CvAssertMsg(i > -1, "Index out of bounds");
	return m_paiBuildingClassTourismChanges ? m_paiBuildingClassTourismChanges[i] : -1;
}
#endif
/// Amount of extra Culture per turn a BuildingClass provides
	...
	for(int i = 0; i < iNumPolicies; i++)
	{
		...
		if(m_pabHasPolicy[i] && !IsPolicyBlocked((PolicyTypes)i))
		{
			...
			case POLICYMOD_EXTRA_HAPPINESS:
				...
				break;
#ifdef AMB_POLICY_BUILDINGGOLDTOCULTURE
			case POLICYMOD_BUILDING_GOLD_TO_CULTURE:
				rtnValue += m_pPolicies->GetPolicyEntry(i)->GetBuildingGoldToCulture();
				break;
#endif
#if defined(AMB_POLICY_EXTRAHAPPINESSPERFOLLOWINGCITY)
			case POLICYMOD_EXTRA_HAPPINESS_FOR_FOLLOWING_CITY:
				rtnValue += m_pPolicies->GetPolicyEntry(i)->GetExtraHappinessForFollowingCity();
				break;
#endif
#if defined(AMB_POLICY_BONUSMINORYIELD)
			case POLICYMOD_BONUS_MINOR_YIELD:
				rtnValue += m_pPolicies->GetPolicyEntry(i)->GetBonusMinorYield();
				break;
#endif
#if defined(AMB_POLICY_FASTERPERSONALQUEST)
			case POLICYMOD_FASTER_PERSONAL_QUEST:
				rtnValue += m_pPolicies->GetPolicyEntry(i)->GetFasterPersonalQuest();
				break;
#endif
#ifdef AMB_POLICY_IDEOLOGIES
			case POLICYMOD_EXTRACOUPCHANCE:
				rtnValue += m_pPolicies->GetPolicyEntry(i)->GetExtraCoupChance();
				break;
			case POLICYMOD_REMOVECOUPCAPCHANCE:
				rtnValue += m_pPolicies->GetPolicyEntry(i)->GetRemoveCoupCapChance();
				break;
			case POLICYMOD_CITYSTRENGTHMODIFIER:
				rtnValue += m_pPolicies->GetPolicyEntry(i)->GetCityStrengthModifier();
				break;
			case POLICYMOD_EXTRACITYHITPOINTS:
				rtnValue += m_pPolicies->GetPolicyEntry(i)->GetExtraCityHitPoints();
				break;
#endif
#if defined(AMB_POLICY_ADDITIONALPERSONALQUEST)
			case POLICYMOD_ADDITIONAL_PERSONAL_QUEST:
				rtnValue += m_pPolicies->GetPolicyEntry(i)->GetAdditionalPersonalQuest();
				break;
#endif
...
#if defined(AMB_POLICY_YIELDCHANGEPERMINORTRADEROUTE)
int CvPlayerPolicies::GetYieldChangePerMinorTradeRoute(YieldTypes eYieldType)
{
	int rtnValue = 0;
	for(int i = 0; i < m_pPolicies->GetNumPolicies(); i++)
	{
		if(m_pabHasPolicy[i] && !IsPolicyBlocked((PolicyTypes)i))
		{
			rtnValue += m_pPolicies->GetPolicyEntry(i)->GetYieldChangePerMinorTradeRoute(eYieldType);
		}
	}
	return rtnValue;
}
#endif
#if defined(AMB_POLICY_YIELDCHANGEPERSEAINTERNATIONALTRADEROUTE)
int CvPlayerPolicies::GetYieldChangePerSeaInternationalTradeRoute(YieldTypes eYieldType)
{
	int rtnValue = 0;
	for(int i = 0; i < m_pPolicies->GetNumPolicies(); i++)
	{
		if(m_pabHasPolicy[i] && !IsPolicyBlocked((PolicyTypes)i))
		{
			rtnValue += m_pPolicies->GetPolicyEntry(i)->GetYieldChangePerSeaInternationalTradeRoute(eYieldType);
		}
	}
	return rtnValue;
}
#endif
#if defined(AMB_POLICY_GREATWORKTOURISMCHANGE)
	int CvPlayerPolicies::GetGreatWorkYieldChange(YieldTypes eYieldType)
	{
		int rtnValue = 0;
		for(int i = 0; i < m_pPolicies->GetNumPolicies(); i++)
		{
			if(m_pabHasPolicy[i] && !IsPolicyBlocked((PolicyTypes)i))
			{
				rtnValue += m_pPolicies->GetPolicyEntry(i)->GetGreatWorkYieldChange(eYieldType);
			}
		}
		return rtnValue;
	}
...
#if defined(AMB_POLICY_PROPHETSPAWNBONUSPERFOLLOWER)
///modAcken This method return total GA bonus per follower when a prophet spawns
	int CvPlayerPolicies::GetTotalProphetSpawnGoldenAgeBonusPerFollower() const
	{
		int iGABonus = 0;
		...
		for(int i = 0; i < m_pPolicies->GetNumPolicies(); i++)
		{
			...
			if(m_pabHasPolicy[i] && !IsPolicyBlocked((PolicyTypes)i))
			{
				iGABonus += m_pPolicies->GetPolicyEntry(i)->GetProphetSpawnGoldenAgeBonusPerFollower();
			}
		}
		return iGABonus;
	}
	///modAcken This method return total Production bonus per follower when a prophet spawns
	int CvPlayerPolicies::GetTotalProphetSpawnProductionBonusPerFollower() const
	{
		int iProductionBonus = 0;
		...
		for(int i = 0; i < m_pPolicies->GetNumPolicies(); i++)
		{
			...
			if(m_pabHasPolicy[i] && !IsPolicyBlocked((PolicyTypes)i))
			{
				iProductionBonus += m_pPolicies->GetPolicyEntry(i)->GetProphetSpawnProductionBonusPerFollower();
			}
		}
		return iProductionBonus;
	}
	///modAcken This method return total Gold bonus per follower when a prophet spawns
	int CvPlayerPolicies::GetTotalProphetSpawnGoldBonusPerFollower() const
	{
		int iGoldBonus = 0;
		...
		for(int i = 0; i < m_pPolicies->GetNumPolicies(); i++)
		{
			...
			if(m_pabHasPolicy[i] && !IsPolicyBlocked((PolicyTypes)i))
			{
				iGoldBonus += m_pPolicies->GetPolicyEntry(i)->GetProphetSpawnGoldBonusPerFollower();
			}
		}
		return iGoldBonus;
	}
#endif
#if defined(AMB_POLICY_EXTRATRADEROUTES)
	///modAcken This method return the number of extra trade routes from policies of a player
	int CvPlayerPolicies::GetNumberExtraTradeRoutes() const
	{
		...
		for(int i = 0; i < m_pPolicies->GetNumPolicies(); i++)
		{
			...
			if(m_pabHasPolicy[i] && !IsPolicyBlocked((PolicyTypes)i))
			{
				iNumTradeRoutes += m_pPolicies->GetPolicyEntry(i)->GetExtraTradeRoutes();
			}
		}
