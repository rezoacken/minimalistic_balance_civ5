...
bool IsTestCityStrategy_SecondCultureBuilding(CvCity* pCity);
bool IsTestCityStrategy_ThirdCultureBuilding(CvCity* pCity);
bool IsTestCityStrategy_FourthCultureBuilding(CvCity* pCity);
bool IsTestCityStrategy_FifthCultureBuilding(CvCity* pCity);
bool IsTestCityStrategy_SecondScienceBuilding(CvCity* pCity);
bool IsTestCityStrategy_ThirdScienceBuilding(CvCity* pCity);
bool IsTestCityStrategy_FourthScienceBuilding(CvCity* pCity);
#endif
