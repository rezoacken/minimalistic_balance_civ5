...
// -- ints --
	...
	m_iAI_GS_CULTURE_INFLUENTIAL_CIV_MOD(30),
#ifdef AMB_MOD_H
#ifdef AMB_AI_DEAL_LOGICAL_VALUES
	GD_INT_INIT(AMB_AI_DEAL_AI_INTEREST,100),
	GD_INT_INIT(AMB_AI_DEAL_HUMAN_INTEREST,115),
#endif
#ifdef MOD_GLOBAL_BREAK_CIVILIAN_1UPT
	GD_INT_INIT(MOD_STACKCIVILIAN,0),
#endif
#ifdef AMB_DIPLOAI_RECKLESS_EXPANDER_OVERHAUL
	GD_INT_INIT(AMB_AI_RECKLESS_EXPANDER_APPROACH_FRIENDLY_MOD,-30),
	GD_INT_INIT(AMB_AI_RECKLESS_EXPANDER_APPROACH_NEUTRAL_MOD,-10),
	GD_INT_INIT(AMB_AI_RECKLESS_EXPANDER_APPROACH_GUARDED_MOD,15),
	GD_INT_INIT(AMB_AI_RECKLESS_EXPANDER_APPROACH_HOSTILE_MOD,20),
	GD_INT_INIT(AMB_AI_RECKLESS_EXPANDER_APPROACH_DECEPTIVE_MOD,30),
	GD_INT_INIT(AMB_AI_RECKLESS_EXPANDER_APPROACH_WAR_MOD,30),
	GD_INT_INIT(AMB_AI_RECKLESS_EXPANDER_APPROACH_AFRAID_MOD,-30),
	GD_INT_INIT(AMB_AI_RECKLESS_EXPANDER_STRENGTH_MOD,20),
	GD_INT_INIT(AMB_AI_RECKLESS_EXPANDER_PERSONALITY_MOD,30),
	GD_INT_INIT(AMB_AI_RECKLESS_EXPANDER_DOF_MOD,20),
	GD_INT_INIT(AMB_AI_RECKLESS_EXPANDER_DENOUNCE_MOD,30),
	GD_INT_INIT(AMB_AI_RECKLESS_EXPANDER_NEIGHBOURS_MOD,10),
	GD_INT_INIT(AMB_AI_RECKLESS_EXPANDER_CLOSE_MOD,0),
	GD_INT_INIT(AMB_AI_RECKLESS_EXPANDER_FAR_MOD,-20),
	GD_INT_INIT(AMB_AI_RECKLESS_EXPANDER_DISTANT_MOD,-30),
	GD_INT_INIT(AMB_AI_RECKLESS_EXPANDER_MOD_APPROACH_MINOR,105),
	GD_INT_INIT(AMB_AI_RECKLESS_EXPANDER_MOD_APPROACH_MAJOR,115),
	GD_INT_INIT(AMB_AI_RECKLESS_EXPANDER_MOD_APPROACH_SEVERE,130),
	GD_INT_INIT(AMB_AI_RECKLESS_EXPANDER_MOD_APPROACH_CRITICAL,160),
#endif
#ifdef AMB_AI_WARMONGER
	GD_INT_INIT(AMB_AI_WARMONGER_CB_APPROACH_WAR_MOD,150),
	GD_INT_INIT(AMB_AI_WARMONGER_CB_APPROACH_DECEPTIVE_MOD,150),
#endif
#ifdef AMB_APPROACH_WAR_CURRENTLY_HOSTILE
	GD_INT_INIT(APPROACH_WAR_CURRENTLY_HOSTILE,3),
#endif
#ifdef AMB_GS_CONQUEST_ARMY_SIZE_BOOST
	GD_INT_INIT(GS_CONQUEST_ARMY_SIZE_BOOST,50),
#endif
#ifdef AMB_APPROACH_DISTANCE_ADDITIONAL_MODIFIERS
	GD_INT_INIT(APPROACH_HOSTILE_PROXIMITY_DISTANT,20),
	GD_INT_INIT(APPROACH_HOSTILE_PROXIMITY_FAR,40),
#endif
#if defined(AMB_AI_GS_CULTURE_FAMILIAR_CIV_MOD)
	m_iAI_GS_CULTURE_FAMILIAR_CIV_MOD(15),//ModAcken
#endif
#if defined(AMB_AI_GS_CULTURE_POPULAR_CIV_MOD)
	m_iAI_GS_CULTURE_POPULAR_CIV_MOD(25),//ModAcken
#endif
#endif
...
#ifdef AMB_MOD_H
#ifdef AMB_AI_DEAL_LOGICAL_VALUES
	GD_INT_CACHE(AMB_AI_DEAL_AI_INTEREST);
	GD_INT_CACHE(AMB_AI_DEAL_HUMAN_INTEREST);
#endif
#ifdef MOD_GLOBAL_BREAK_CIVILIAN_1UPT
	GD_INT_CACHE(MOD_STACKCIVILIAN);
#endif
#ifdef AMB_DIPLOAI_RECKLESS_EXPANDER_OVERHAUL
	GD_INT_CACHE(AMB_AI_RECKLESS_EXPANDER_APPROACH_FRIENDLY_MOD);
	GD_INT_CACHE(AMB_AI_RECKLESS_EXPANDER_APPROACH_NEUTRAL_MOD);
	GD_INT_CACHE(AMB_AI_RECKLESS_EXPANDER_APPROACH_GUARDED_MOD);
	GD_INT_CACHE(AMB_AI_RECKLESS_EXPANDER_APPROACH_HOSTILE_MOD);
	GD_INT_CACHE(AMB_AI_RECKLESS_EXPANDER_APPROACH_DECEPTIVE_MOD);
	GD_INT_CACHE(AMB_AI_RECKLESS_EXPANDER_APPROACH_WAR_MOD);
	GD_INT_CACHE(AMB_AI_RECKLESS_EXPANDER_APPROACH_AFRAID_MOD);
	GD_INT_CACHE(AMB_AI_RECKLESS_EXPANDER_STRENGTH_MOD);
	GD_INT_CACHE(AMB_AI_RECKLESS_EXPANDER_PERSONALITY_MOD);
	GD_INT_CACHE(AMB_AI_RECKLESS_EXPANDER_DOF_MOD);
	GD_INT_CACHE(AMB_AI_RECKLESS_EXPANDER_DENOUNCE_MOD);
	GD_INT_CACHE(AMB_AI_RECKLESS_EXPANDER_NEIGHBOURS_MOD);
	GD_INT_CACHE(AMB_AI_RECKLESS_EXPANDER_CLOSE_MOD);
	GD_INT_CACHE(AMB_AI_RECKLESS_EXPANDER_FAR_MOD);
	GD_INT_CACHE(AMB_AI_RECKLESS_EXPANDER_DISTANT_MOD);
	GD_INT_CACHE(AMB_AI_RECKLESS_EXPANDER_MOD_APPROACH_MINOR);
	GD_INT_CACHE(AMB_AI_RECKLESS_EXPANDER_MOD_APPROACH_MAJOR);
	GD_INT_CACHE(AMB_AI_RECKLESS_EXPANDER_MOD_APPROACH_SEVERE);
	GD_INT_CACHE(AMB_AI_RECKLESS_EXPANDER_MOD_APPROACH_CRITICAL);
#endif
#ifdef AMB_AI_WARMONGER
	GD_INT_CACHE(AMB_AI_WARMONGER_CB_APPROACH_WAR_MOD);
	GD_INT_CACHE(AMB_AI_WARMONGER_CB_APPROACH_DECEPTIVE_MOD);
#endif
#ifdef AMB_APPROACH_WAR_CURRENTLY_HOSTILE
	GD_INT_CACHE(APPROACH_WAR_CURRENTLY_HOSTILE);
#endif
#ifdef AMB_GS_CONQUEST_ARMY_SIZE_BOOST
	GD_INT_CACHE(GS_CONQUEST_ARMY_SIZE_BOOST);
#endif
#ifdef AMB_APPROACH_DISTANCE_ADDITIONAL_MODIFIERS
	GD_INT_CACHE(APPROACH_HOSTILE_PROXIMITY_DISTANT);
	GD_INT_CACHE(APPROACH_HOSTILE_PROXIMITY_FAR);
#endif
#if defined(AMB_AI_GS_CULTURE_POPULAR_CIV_MOD)
	m_iAI_GS_CULTURE_POPULAR_CIV_MOD = getDefineINT("AI_GS_CULTURE_POPULAR_CIV_MOD");//modAcken
#endif
#if defined(AMB_AI_GS_CULTURE_FAMILIAR_CIV_MOD)
	m_iAI_GS_CULTURE_FAMILIAR_CIV_MOD = getDefineINT("AI_GS_CULTURE_FAMILIAR_CIV_MOD");//modAcken
#endif
#endif
