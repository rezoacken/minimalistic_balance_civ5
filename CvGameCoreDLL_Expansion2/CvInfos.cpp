...
CvHandicapInfo::CvHandicapInfo() :
	...
	m_iAINumCitiesExponent(0),
#endif
#ifdef AMB_AI_DIFFICULTY_TOURISM_BONUS
	m_iAITourismAdditiveModifier(0),
#endif
...
//------------------------------------------------------------------------------
#ifdef AMB_TECH_PENALTY_OVERHAUL
int CvHandicapInfo::getAINumCitiesExponent() const
{
	return m_iAINumCitiesExponent;
}
#endif
//------------------------------------------------------------------------------
#ifdef AMB_AI_DIFFICULTY_TOURISM_BONUS
int CvHandicapInfo::getAITourismAdditiveModifier() const
{
	return m_iAITourismAdditiveModifier;
}
#endif
//------------------------------------------------------------------------------
...
#ifdef AMB_TECH_PENALTY_OVERHAUL
	m_iAINumCitiesExponent = kResults.GetInt("AINumCitiesExponent");
#endif
