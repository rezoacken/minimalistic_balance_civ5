...
#ifdef AMB_BELIEF_SETTLERPRODUCTION
int CvBeliefEntry::GetSettlerProductionModifier() const
{
	return m_iSettlerProductionModifier;
}
#endif
#ifdef AMB_BELIEF_CITYSTRENGTH
int CvBeliefEntry::GetCityStrengthModifier() const
{
...
{
#ifdef AMB_BELIEF_SETTLERPRODUCTION
	m_iSettlerProductionModifier = source.m_iSettlerProductionModifier;
#endif
#ifdef AMB_BELIEF_CITYSTRENGTH
	m_iCityStrengthModifier = source.m_iCityStrengthModifier;
#endif
...
void CvReligionBeliefs::AddBelief(BeliefTypes eBelief)
{
	...
	if(belief == NULL)
		return;
#ifdef AMB_BELIEF_SETTLERPRODUCTION
	m_iSettlerProductionModifier += belief->GetSettlerProductionModifier();
#endif
#ifdef AMB_BELIEF_CITYSTRENGTH
	m_iCityStrengthModifier += belief->GetCityStrengthModifier();
#endif
...
#endif
#ifdef AMB_BELIEF_CITYSTRENGTH
	kStream >> m_iCityStrengthModifier;
#endif
