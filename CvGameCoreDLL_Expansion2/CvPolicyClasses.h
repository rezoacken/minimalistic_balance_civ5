...
public:
	...
	int GetBuildingGoldToCulture() const;
#endif
#if defined(AMB_POLICY_EXTRATRADEROUTES)
	int GetExtraTradeRoutes() const; //modAcken Returns m_iExtraTradeRoutes
#endif
#if defined(AMB_POLICY_PROPHETSPAWNBONUSPERFOLLOWER)
	int GetProphetSpawnGoldenAgeBonusPerFollower() const; //modAcken Returns m_iProphetSpawnGoldenAgeBonusPerFollower
	int GetProphetSpawnGoldBonusPerFollower() const; //modAcken Returns m_iProphetSpawnGoldBonusPerFollower
	int GetProphetSpawnProductionBonusPerFollower() const; //modAcken Returns m_iProphetSpawnProductionBonusPerFollower
#endif
#if defined(AMB_POLICY_EXTRAHAPPINESSPERFOLLOWINGCITY)
	int GetExtraHappinessForFollowingCity() const; //modAcken
#endif
#if defined(AMB_POLICY_ADDITIONALPERSONALQUEST)
	int GetAdditionalPersonalQuest() const; //modAcken
#endif
#if defined(AMB_POLICY_FASTERPERSONALQUEST)
	int GetFasterPersonalQuest() const; //modAcken
#endif
#if defined(AMB_POLICY_BONUSMINORYIELD)
	int GetBonusMinorYield() const; //modAcken
#endif
#ifdef AMB_POLICY_IDEOLOGIES
	int GetExtraCoupChance() const;
	int GetRemoveCoupCapChance() const;
	int GetCityStrengthModifier() const;
	...
	int GetNumCitiesFreeDefenseBuilding() const;
#endif
	...
	int GetBuildingClassTourismChange(int i) const;
#endif
...
private:
#ifdef AMB_POLICY_BUILDINGGOLDTOCULTURE
	int m_iBuildingGoldToCulture;
#endif
#if defined(AMB_POLICY_EXTRATRADEROUTES)
	int m_iExtraTradeRoutes; //modAcken stored value in policy entry for extra routes
#endif
#if defined(AMB_POLICY_PROPHETSPAWNBONUSPERFOLLOWER)
	int m_iProphetSpawnGoldenAgeBonusPerFollower; //modAcken stored value in policy entry for total Prophet spawn GA bonus
	int m_iProphetSpawnGoldBonusPerFollower; //modAcken stored value in policy entry for total Prophet spawn gold bonus
	int m_iProphetSpawnProductionBonusPerFollower; //modAcken stored value in policy entry for total Prophet spawn production bonus
#endif
#if defined(AMB_POLICY_EXTRAHAPPINESSPERFOLLOWINGCITY)
	int m_iExtraHappinessForFollowingCity;//modAcken
#endif
#if defined(AMB_POLICY_ADDITIONALPERSONALQUEST)
	int m_iAdditionalPersonalQuest;//modAcken
#endif
#if defined(AMB_POLICY_FASTERPERSONALQUEST)
	int m_iFasterPersonalQuest;//modAcken
#endif
#if defined(AMB_POLICY_BONUSMINORYIELD)
	int m_iBonusMinorYield;//modAcken
#endif
#ifdef AMB_POLICY_IDEOLOGIES
	int m_iExtraCoupChance;
	int m_iRemoveCoupCapChance;
	int m_iCityStrengthModifier;
...
#ifdef AMB_POLICY_FREEDEFENSE
	int m_iNumCitiesFreeDefenseBuilding;
#endif 
...
#if defined(AMB_POLICY_YIELDCHANGEPERMINORTRADEROUTE)
	int* m_piYieldChangePerMinorTradeRoute;
#endif
#if defined(AMB_POLICY_YIELDCHANGEPERSEAINTERNATIONALTRADEROUTE)
	int* m_piYieldChangePerSeaInternationalTradeRoute;
#endif
...
#ifdef AMB_POLICY_BUILDINGGOLDTOCULTURE
	POLICYMOD_BUILDING_GOLD_TO_CULTURE,
#endif
#if defined(AMB_POLICY_EXTRAHAPPINESSPERFOLLOWINGCITY)
	POLICYMOD_EXTRA_HAPPINESS_FOR_FOLLOWING_CITY, //modAcken for piety religious fervour
#endif
#if defined(AMB_POLICY_ADDITIONALPERSONALQUEST)
	POLICYMOD_ADDITIONAL_PERSONAL_QUEST,
#endif
#if defined(AMB_POLICY_FASTERPERSONALQUEST)
	POLICYMOD_FASTER_PERSONAL_QUEST,
#endif
#if defined(AMB_POLICY_BONUSMINORYIELD)
	POLICYMOD_BONUS_MINOR_YIELD,
#endif
#ifdef AMB_POLICY_IDEOLOGIES
	POLICYMOD_EXTRACOUPCHANCE,
	POLICYMOD_REMOVECOUPCAPCHANCE,
	POLICYMOD_CITYSTRENGTHMODIFIER,
	POLICYMOD_EXTRACITYHITPOINTS,
#endif
...
#if defined(AMB_POLICY_EXTRATRADEROUTES)
	int GetNumberExtraTradeRoutes() const; //modAcken header for total trade routes from policies
#endif
#if defined(AMB_POLICY_PROPHETSPAWNBONUSPERFOLLOWER)
	int GetTotalProphetSpawnGoldenAgeBonusPerFollower() const; //modAcken header for total Prophet spawn GA bonus
	int GetTotalProphetSpawnGoldBonusPerFollower() const; //modAcken header for total Prophet spawn gold bonus
	int GetTotalProphetSpawnProductionBonusPerFollower() const; //modAcken header for total Prophet spawn production bonus
#endif
#if defined(AMB_POLICY_YIELDCHANGEPERMINORTRADEROUTE)
	int GetYieldChangePerMinorTradeRoute(YieldTypes eYieldType);
#endif
#if defined(AMB_POLICY_YIELDCHANGEPERSEAINTERNATIONALTRADEROUTE)
	int GetYieldChangePerSeaInternationalTradeRoute(YieldTypes eYieldType);
#endif
#if defined(AMB_POLICY_GREATWORKTOURISMCHANGE)
	int GetGreatWorkYieldChange(YieldTypes eYieldType);
#endif
