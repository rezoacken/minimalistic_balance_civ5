...
public:
	...
	void DoTestWarmongerThreatToMinorsWithThisUnitsDeath(PlayerTypes eKillingPlayer);
#endif
	...
	int GetTreatyValue() const;
#endif

#ifdef AMB_FIXED_GS_BULB
	int GetBulbValue() const; //modAcken Return the bulbvalue from m_iBulbValue
#endif
...
#endif
#ifdef AMB_FIXED_GS_BULB
	int m_iBulbValue; //modAcken stores the fixed Bulb Value 
#endif
