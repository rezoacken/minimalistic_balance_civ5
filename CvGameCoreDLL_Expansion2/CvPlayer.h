...
public:
	...
	void ChangeNumCitiesFreeDefenseBuilding(int iChange);
#endif
	...
	int GetReducedResistance() const;
	void ChangeReducedResistance(int iChange);
#endif
	...
	int getGreatScientistCreated() const;
	int getGreatEngineerCreated() const;
	int getGreatMerchantCreated() const;
	void incrementGreatScientistCreated();
	void incrementGreatEngineerCreated();
	void incrementGreatMerchantCreated();
#endif
...
#ifdef AMB_BUILDING_REDUCED_RESISTANCE
	FAutoVariable<int, CvPlayer> m_iReducedResistance;
#endif
...
#ifdef AMB_PARTIAL_GP_COUNTERS
	int m_iGreatScientistCreated;
	int m_iGreatEngineerCreated;
	int m_iGreatMerchantCreated;
#endif
