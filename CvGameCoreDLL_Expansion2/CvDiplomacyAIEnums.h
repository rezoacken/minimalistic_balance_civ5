...
enum RecklessExpanderTypes
{
    NO_RECKLESS_EXPANDER_TYPE = -1,

    // WARNING: the order of these values is very important, do not change unless you know what you're doing!
    RECKLESS_EXPANDER_NONE,
    RECKLESS_EXPANDER_MINOR,
	RECKLESS_EXPANDER_MAJOR,
    RECKLESS_EXPANDER_SEVERE,
    RECKLESS_EXPANDER_CRITICAL,
    // WARNING: the order of these values is very important, do not change unless you know what you're doing!

    NUM_RECKLESS_EXPANDERS,
};
#endif
